...
import pkgfinal.year.assistant.supervisorcomponent.currentlysupervising.*;
 ...
 * @author Nelly
 */
public class list_appointments extends Application{
    ...
    public void start(Stage stage) throws Exception {
      ...
      stage.show();
      stage.setTitle("APPOINTMENTS LIST PAGE");
    }
