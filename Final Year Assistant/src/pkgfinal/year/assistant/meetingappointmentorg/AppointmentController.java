...
import pkgfinal.year.assistant.meetingappointment.*;
...
public class AppointmentController implements Initializable {
    ...
    private void AM_7_box_cliked(MouseEvent event) {
       ...
       JOptionPane.showMessageDialog(null, "Selected appointment time at!" + Appointment_Time , "MESSAGE", JOptionPane.INFORMATION_MESSAGE);
     }
